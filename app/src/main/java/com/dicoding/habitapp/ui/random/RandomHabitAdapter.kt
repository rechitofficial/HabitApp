...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            val icPriorityQueue = when (pageType) {
            ...
            itemView.findViewById<ImageView>(R.id.pager_priority_level).setImageResource(icPriorityQueue)
            itemView.findViewById<Button>(R.id.btn_open_count_down).setOnClickListener { onClick(pageData) }
